...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7414819740:AAEXhob4i2SxSx-6dnGKdnBTMCx-M3p_KTU")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "24994752"))
...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Blow0utt")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "891959176"))
#Port
PORT = os.environ.get("PORT", "8030")
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://liebugfry:oZ70qestZEfzk6Q0@cluster0.li92x.mongodb.net/?retryWrites=true&w=majority")
...
try:
    ADMINS=[891959176]
    for x in (os.environ.get("ADMINS", "891959176 6273945163 6103092779 5231212075").split()):
        ADMINS.append(int(x))
except ValueError:
